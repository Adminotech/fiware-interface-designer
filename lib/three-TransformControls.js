...
THREE.TransformControls = function ( camera, domElement ) {
	...
	this.update = function () {
		...
		camPosition.getPositionFromMatrix( scope.camera.matrixWorld );
	...
	function onPointerUp( event ) {
		var dragStopEvent = new CustomEvent(
			"dragStop", 
			{
				detail: {
					object : scope.object,
		...
		if (scope.object !== undefined && _dragging)
			scope.dispatchEvent(dragStopEvent);

		_dragging = false;
		onPointerHover( event );
		// TODO here be undo redo stuff
